...
--- output ---
    ...
    P00   INFO: P1-T1/1 - vm=none, module=common, test=wait
        ...
        2023-05-17 08:11:19.730 P00   INFO: test command begin 2.46: [common/wait] --log-level=info --repo-path=/home/vagrant/test/repo --test-path=/home/vagrant/test --vm=none --vm-id=0
        2023-05-17 08:11:22.188 P00   INFO: test command end: completed successfully (2458ms)
        run 1 - waitNew(), waitMore, and waitFree()
            000.010s          L0018     expect AssertError: assertion 'waitTime <= 999999000' failed
        
        run 1/1 ------------- L0021 0ms wait
            001.715s 001.705s L0025     new wait
            001.726s 000.011s L0026         check remaining time
            001.727s 000.001s L0027         check wait time
            001.728s 000.001s L0028         check sleep time
            001.729s 000.001s L0029         check sleep prev time
            001.730s 000.001s L0030         no wait more
            001.735s 000.005s L0033     new wait = 0.2 sec
            001.736s 000.001s L0034         check remaining time
            001.737s 000.001s L0035         check wait time
            001.738s 000.001s L0036         check sleep time
            001.739s 000.001s L0037         check sleep prev time
            001.740s 000.001s L0038         check begin time
            001.938s 000.198s L0044         lower range check
            001.938s 000.000s L0045         upper range check
            001.939s 000.001s L0047         free wait
            001.941s 000.002s L0052     new wait = 1.1 sec
            001.942s 000.001s L0053         check wait time
            001.943s 000.001s L0054         check sleep time
            001.944s 000.001s L0055         check sleep prev time
            001.945s 000.001s L0056         check begin time
            003.043s 001.098s L0062         lower range check
            003.044s 000.001s L0063         upper range check
            003.044s 000.000s L0065         free wait
...
--- output ---
    ...
    P00   WARN: process has been running for 300 seconds with no output
    P00   WARN: process has been running for 300 seconds with no output
